...
class TransacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transacao" do
    assert_difference("Transacao.count") do
      post transacaos_url, params: { transacao: { cliente_id: @transacao.cliente_id, data: @transacao.data, descricao: @transacao.descricao, tipo: @transacao.tipo, valor: @transacao.valor } }
    end
  ...
  test "should update transacao" do
    patch transacao_url(@transacao), params: { transacao: { cliente_id: @transacao.cliente_id, data: @transacao.data, descricao: @transacao.descricao, tipo: @transacao.tipo, valor: @transacao.valor } }
